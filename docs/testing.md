...
| `@s3-transfer-faults` | No-network simulator run of the generated S3 transfer fault workload. | No |
| `@s3-minio-workload` | Docker-backed MinIO run of the shared S3 state workload and bounded transfer cases. | Local Docker |
...
| `@test/awskit-s3/sim/s3-transfer-faults` | Focused simulator run of the generated S3 transfer fault workload. | No |
