...
module type Response_reader = sig
  type +'a io
...
module type Object_operations = sig
...
module type Bucket_operations = sig
...
module type Multipart_operations = sig
...
module type Presigned_operations = sig
