...
module Make (R : RUNTIME) = struct
  ...
  module Object = Awskit_s3_object_ops.Make (Context)
  module Bucket = Awskit_s3_bucket_ops.Make (Context)
  module Multipart = Awskit_s3_multipart_ops.Make (Context)
  module Presigned = Awskit_s3_presigned_ops.Make (Context)
end
